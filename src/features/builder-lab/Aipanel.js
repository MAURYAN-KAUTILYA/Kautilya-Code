            ...
            position: "relative",
                    ...
                    background: `linear-gradient(180deg, rgba(var(--accent-rgb), 0.08) 0%, ${T.bg} 100%)`,
                        ...
                        boxShadow: "var(--shadow-md)",
                                        ...
                                        cursor: "pointer",
                                        transition: T.transition,
                                    }, onMouseEnter: e => { e.currentTarget.style.background = T.bgWarmHover; e.currentTarget.style.transform = "translateY(-1px)"; }, onMouseLeave: e => { e.currentTarget.style.background = modelMenuOpen ? "var(--accent-soft)" : "transparent"; e.currentTarget.style.transform = "none"; }, children: [_jsx("span", { style: { color: T.text, fontWeight: 500 }, children: selectedVariant.label }), _jsx("span", { style: {
                                ...
                                animation: "kMenuPopUp 0.3s cubic-bezier(.25,.1,.25,1) forwards", transformOrigin: "bottom center",
                                        ...
                                        return (_jsxs("div", { children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, padding: "4px 8px 0" }, children: [_jsxs("button", { onClick: () => setExpandedModel(prev => prev === model.id ? "" : model.id), style: {
                                                        ...
                                                        }, onMouseEnter: e => { e.currentTarget.style.background = T.bgWarmHover; }, onMouseLeave: e => { e.currentTarget.style.background = variant === model.id && section === entry ? "var(--accent-soft)" : "transparent"; }, children: [_jsx("span", { children: entry }), variant === model.id && section === entry && _jsx("span", { style: { color: T.accent, fontSize: 12 }, children: "\u2713" })] }, `${model.id}-${entry}`))) }))] }, model.id));
                                    }) })] })), _jsxs("div", { style: {
                                ...
                                transition: T.transition,
                                    ...
                                    boxShadow: "inset 0 1px 0 rgba(255,255,255,0.03)",
                                        ...
                                        display: "flex", borderRadius: 6, border: `1px solid ${T.border}`, overflow: "hidden", flexShrink: 0,
                                            ...
                                            e.currentTarget.style.background = "transparent"; }, children: mode }, mode))) }), _jsx(CommandLauncher, { onOpen: () => onCommandSheetOpenChange(true), activeCount: draftCommands.length }), _jsxs("div", { style: { position: "relative", flexShrink: 0 }, "data-menu": "attach", children: [_jsx("button", { onClick: () => { setAttachmentMenuOpen(v => !v); setImportMenuOpen(false); setModelMenuOpen(false); setMoreMenuOpen(false); setParallelMenuOpen(false); setSecurityMenuOpen(false); }, "data-menu": "attach", style: { width: 28, height: 28, borderRadius: 7, border: "none", background: attachmentMenuOpen ? "var(--accent-soft)" : "transparent", color: attachmentMenuOpen ? T.textSec : T.textTer, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: T.transition }, onMouseEnter: e => { e.currentTarget.style.background = T.bgWarmHover; e.currentTarget.style.color = T.textSec; e.currentTarget.style.transform = "scale(1.08)"; }, onMouseLeave: e => { e.currentTarget.style.background = attachmentMenuOpen ? "var(--accent-soft)" : "transparent"; e.currentTarget.style.color = attachmentMenuOpen ? T.textSec : T.textTer; e.currentTarget.style.transform = "scale(1)"; }, children: _jsx(IAdd, {}) }), attachmentMenuOpen && (_jsxs("div", { "data-menu": "attach", style: { position: "absolute", right: 0, bottom: "calc(100% + 6px)", width: 254, background: "var(--builder-glass-strong)", backdropFilter: T.blur, WebkitBackdropFilter: T.blur, border: `1px solid ${T.borderMed}`, borderRadius: T.radius, zIndex: 80, overflow: "hidden", boxShadow: T.shadow, animation: "kMenuPopUp 0.3s cubic-bezier(.25,.1,.25,1) forwards", transformOrigin: "bottom right" }, children: [_jsx("div", { style: { padding: "10px 14px", borderBottom: `1px solid ${T.border}` }, children: _jsx("div", { style: { fontFamily: T.mono, fontSize: 9, color: T.textTer, letterSpacing: "0.08em", textTransform: "uppercase" }, children: "Attach & Import" }) }), _jsxs("div", { style: { padding: 10, display: "flex", flexDirection: "column", gap: 6 }, children: [_jsxs("button", { onClick: () => { onOpenSketchBoard(); setAttachmentMenuOpen(false); }, style: { width: "100%", border: "1px solid rgba(var(--accent-rgb), 0.28)", borderRadius: 12, background: "linear-gradient(135deg, rgba(var(--accent-rgb), 0.18) 0%, rgba(var(--accent-alt-rgb), 0.12) 100%)", color: "#F8FAFC", padding: "12px 13px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer", boxShadow: "0 10px 28px rgba(15,23,42,0.18), inset 0 1px 0 rgba(255,255,255,0.2)", overflow: "hidden", position: "relative" }, children: [_jsx("span", { style: { position: "absolute", inset: 0, background: "radial-gradient(circle at top left, rgba(255,255,255,0.16), transparent 48%), radial-gradient(circle at bottom right, rgba(var(--accent-rgb), 0.16), transparent 42%)", pointerEvents: "none" } }), _jsxs("span", { style: { display: "flex", alignItems: "center", gap: 9, fontFamily: T.font, fontSize: 12.5, fontWeight: 500, position: "relative", zIndex: 1 }, children: [_jsx("span", { style: { display: "flex", color: "#ffffff" }, children: _jsx(ISketch, {}) }), "Sketch your design"] }), _jsx("span", { style: { fontFamily: T.mono, fontSize: 9, color: "rgba(255,255,255,0.76)", position: "relative", zIndex: 1 }, children: "BOARD" })] }), _jsxs("button", { onClick: () => { onAttachFiles(); setAttachmentMenuOpen(false); }, style: { width: "100%", border: `1px solid ${T.border}`, borderRadius: 10, background: "rgba(255,255,255,0.03)", color: T.text, padding: "10px 12px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer", transition: T.transition }, children: [_jsxs("span", { style: { display: "flex", alignItems: "center", gap: 8, fontFamily: T.font, fontSize: 12 }, children: [_jsx("span", { style: { display: "flex", color: T.accent }, children: _jsx(IOpenFile, {}) }), "Upload files"] }), _jsx("span", { style: { fontFamily: T.mono, fontSize: 9, color: T.textTer }, children: "FILES ONLY" })] }), _jsxs("button", { onClick: () => { onAttachImages(); setAttachmentMenuOpen(false); }, style: { width: "100%", border: "1px solid rgba(59,130,246,0.18)", borderRadius: 10, background: "rgba(59,130,246,0.08)", color: "#DBEAFE", padding: "10px 12px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer", transition: T.transition }, children: [_jsxs("span", { style: { display: "flex", alignItems: "center", gap: 8, fontFamily: T.font, fontSize: 12 }, children: [_jsx("span", { style: { display: "flex", color: "#60A5FA" }, children: _jsx(IUpload, {}) }), "Upload image"] }), _jsx("span", { style: { fontFamily: T.mono, fontSize: 9, color: "rgba(191,219,254,0.72)" }, children: "IMAGE" })] }), _jsxs("button", { onClick: () => setImportMenuOpen(v => !v), style: { width: "100%", border: `1px solid ${T.border}`, borderRadius: 10, background: importMenuOpen ? "var(--accent-soft)" : "rgba(255,255,255,0.025)", color: T.textSec, padding: "10px 12px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer", transition: T.transition }, children: [_jsx("span", { style: { fontFamily: T.font, fontSize: 12 }, children: "More imports" }), _jsx(IChevD, {})] }), importMenuOpen ? (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6, paddingTop: 4 }, children: [[
                                                                ...
                                                                ].map((item) => (_jsxs("button", { disabled: true, style: { width: "100%", border: `1px solid ${T.border}`, borderRadius: 11, background: item.tone, color: T.textSec, padding: "10px 12px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "not-allowed", opacity: 0.9 }, children: [_jsxs("span", { style: { display: "flex", alignItems: "center", gap: 9, fontFamily: T.font, fontSize: 12 }, children: [_jsx("span", { style: { display: "flex" }, children: item.icon }), item.label] }), _jsx("span", { style: { fontFamily: T.mono, fontSize: 9, color: T.textTer }, children: "SOON" })] }, item.id))), _jsxs("button", { disabled: true, style: { width: "100%", border: "1px solid rgba(var(--accent-rgb), 0.28)", borderRadius: 12, background: "linear-gradient(135deg, rgba(var(--accent-rgb), 0.16) 0%, rgba(17,17,24,0.92) 100%)", color: "var(--accent-alt)", padding: "12px 13px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "not-allowed", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.05)" }, children: [_jsxs("span", { style: { display: "flex", alignItems: "center", gap: 9, fontFamily: T.font, fontSize: 12.5, fontWeight: 500 }, children: [_jsx("span", { style: { display: "flex", color: "var(--accent-alt)" }, children: _jsx(IDocGem, {}) }), "Import from Kautilya Docs"] }), _jsx("span", { style: { fontFamily: T.mono, fontSize: 9, color: "rgba(var(--accent-alt-rgb), 0.76)" }, children: "PREMIUM SOON" })] })] })) : null] })] }))] }), _jsxs("div", { style: { position: "relative", flexShrink: 0 }, "data-menu": "more", children: [_jsx("button", { onClick: () => { setMoreMenuOpen(v => !v); setAttachmentMenuOpen(false); setImportMenuOpen(false); setModelMenuOpen(false); setParallelMenuOpen(false); setSecurityMenuOpen(false); }, "data-menu": "more", style: {
                    ...
                    padding: "5px 10px 10px", position: "relative",
                                    ...
                                    animation: "kMenuPopUp 0.3s cubic-bezier(.25,.1,.25,1) forwards", transformOrigin: "bottom right",
                                            ...
                                            }, onMouseEnter: e => { e.currentTarget.style.background = T.bgWarmHover; }, onMouseLeave: e => { e.currentTarget.style.background = selectedSecurity === opt.id ? "var(--accent-soft)" : "transparent"; }, children: [selectedSecurity === opt.id && _jsx("span", { style: { color: T.accent, fontSize: 8 }, children: "\u25CF" }), _jsx("span", { children: opt.label })] }, opt.id))) })] }))] })] }), modelSpotlight && (_jsx("div", { onClick: () => setModelSpotlight(null), style: {
                    position: "absolute",
                    inset: 0,
                    zIndex: 105,
                    ...
                    padding: 14,
                        ...
                        animation: "kSpotlightEnter 0.36s cubic-bezier(.22,1,.36,1)",
                                        ...
                                        gap: 12,
                                                ...
                                                maxWidth: 194,
                                            }, children: [_jsx("span", { style: { color: "var(--builder-inverse-text)", display: "flex", flexShrink: 0 }, children: _jsx(ISpotlight, {}) }), _jsx("span", { style: {
