...
function IconDelete() { return _jsxs("svg", { viewBox: "0 0 24 24", width: "16", height: "16", fill: "none", children: [_jsx("path", { d: "M6 7h12M9 7V5h6v2M10 11v5M14 11v5", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round" }), _jsx("path", { d: "M7 7l1 11a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1l1-11", stroke: "currentColor", strokeWidth: "1.6", strokeLinejoin: "round" })] }); }
function IconDuplicate() { return _jsxs("svg", { viewBox: "0 0 24 24", width: "16", height: "16", fill: "none", children: [_jsx("rect", { x: "8", y: "8", width: "10", height: "10", rx: "2", stroke: "currentColor", strokeWidth: "1.6" }), _jsx("path", { d: "M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2", stroke: "currentColor", strokeWidth: "1.6" })] }); }
...
export default function SketchBoard({ open, value, defaultValue, onChange, onContextChange, onNotesChange, onClose }) {
    ...
    const startStroke = (point) => {
        ...
        const stroke = { id, type: "stroke", x: 0, y: 0, points: initialPoints, color: brush.color, width: brush.width, brush: brush.kind };
    ...
    return (_jsx("div", { ref: overlayRef, tabIndex: -1, onKeyDown: (e) => {
            ...
            onClose?.(); }, children: _jsxs("div", { style: { width: "min(70vw, 1280px)", height: "min(80vh, 860px)", minWidth: "min(900px, 96vw)", minHeight: "min(620px, 86vh)", maxWidth: "96vw", maxHeight: "92vh", borderRadius: 32, background: "linear-gradient(180deg, rgba(255,255,255,0.95), rgba(248,250,252,0.98))", boxShadow: "0 40px 120px rgba(15,23,42,0.28), inset 0 1px 0 rgba(255,255,255,0.85)", border: "1px solid rgba(148,163,184,0.2)", overflow: "hidden", display: "flex", flexDirection: "column" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 18px 14px", borderBottom: "1px solid rgba(148,163,184,0.15)", background: "linear-gradient(180deg, rgba(255,255,255,0.82), rgba(248,250,252,0.95))" }, children: [_jsxs("div", { children: [_jsx("div", { style: { fontSize: 12, letterSpacing: "0.18em", textTransform: "uppercase", color: "#64748B", fontWeight: 700 }, children: "Sketch Your Design" }), _jsx("div", { style: { fontSize: 13, color: "#0F172A", marginTop: 5 }, children: "Apple-inspired whiteboard with selectable pages, lines, notes, and text." })] }), _jsx("button", { type: "button", onClick: () => onClose?.(), style: { width: 42, height: 42, borderRadius: 999, border: "1px solid rgba(148,163,184,0.18)", background: "rgba(255,255,255,0.9)", color: "#1F2937", cursor: "pointer", display: "grid", placeItems: "center", boxShadow: "0 10px 20px rgba(15,23,42,0.10)" }, children: _jsx(IconClose, {}) })] }), _jsxs("div", { style: { flex: 1, minHeight: 0, display: "flex", padding: 16, gap: 16, background: "linear-gradient(180deg, rgba(246,248,252,1), rgba(241,245,249,0.92))", position: "relative" }, children: [_jsxs("div", { style: { width: 74, flexShrink: 0, position: "relative" }, children: [_jsxs("div", { style: { position: "absolute", inset: 0, borderRadius: 28, background: "rgba(255,255,255,0.78)", border: "1px solid rgba(148,163,184,0.16)", boxShadow: "0 14px 34px rgba(15,23,42,0.08)", backdropFilter: "blur(14px)", display: "flex", flexDirection: "column", alignItems: "center", padding: "14px 10px", gap: 10 }, children: [toolButton("select", _jsx(IconSelect, {}), "Select"), toolButton("pencil", _jsx(IconPencil, {}), "Pencil", "pencil"), toolButton("shapes", _jsx(IconShapes, {}), "Shapes", "shapes"), toolButton("line", _jsx(IconLine, {}), "Line", "line"), toolButton("sticky", _jsx(IconSticky, {}), "Sticky note", "sticky"), toolButton("text", _jsx(IconText, {}), "Text"), _jsx("div", { style: { flex: 1 } })] }), popover === "pencil" ? (_jsx(Flyout, { title: "Drawing", onClose: closePopover, align: "left", children: _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [_jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8 }, children: ["pencil", "marker", "highlighter"].map((kind) => (_jsx("button", { type: "button", onClick: () => updateScene({ brush: { ...brush, kind } }), style: { border: brush.kind === kind ? "1px solid rgba(91,115,255,0.4)" : "1px solid rgba(148,163,184,0.16)", background: brush.kind === kind ? "rgba(91,115,255,0.09)" : "rgba(255,255,255,0.85)", borderRadius: 14, padding: "10px 8px", fontSize: 12, color: "#0F172A", cursor: "pointer" }, children: kind }, kind))) }), _jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 8 }, children: COLORS.map((color) => _jsx("button", { type: "button", onClick: () => updateScene({ brush: { ...brush, color } }), style: { width: 28, height: 28, borderRadius: 999, border: brush.color === color ? "2px solid rgba(15,23,42,0.75)" : "2px solid rgba(255,255,255,0.85)", background: color, boxShadow: "0 6px 14px rgba(15,23,42,0.10)", cursor: "pointer" } }, color)) }), _jsx("div", { style: { display: "flex", gap: 8 }, children: [2, 3, 5, 7].map((width) => _jsx("button", { type: "button", onClick: () => updateScene({ brush: { ...brush, width } }), style: { flex: 1, borderRadius: 999, border: brush.width === width ? "1px solid rgba(91,115,255,0.4)" : "1px solid rgba(148,163,184,0.16)", background: "rgba(255,255,255,0.88)", padding: "8px 0", cursor: "pointer", display: "grid", placeItems: "center" }, children: _jsx("span", { style: { width, height: width, borderRadius: 999, background: brush.color, display: "block" } }) }, width)) })] }) })) : null, popover === "shapes" ? (_jsx(Flyout, { title: "Shapes", onClose: closePopover, align: "left", children: _jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 8 }, children: [["square", "Square"], ["rounded", "Rounded"], ["circle", "Circle"], ["triangle", "Triangle"], ["triangleDown", "Down"], ["diamond", "Diamond"], ["pentagon", "Pentagon"]].map(([kind, label]) => (_jsxs("button", { type: "button", onClick: () => { updateScene({ shapeKind: kind, tool: "shapes" }); createElementFromCenter((center) => ({ ...createShape(center), kind })); closePopover(); }, style: { border: shapeKind === kind ? "1px solid rgba(91,115,255,0.4)" : "1px solid rgba(148,163,184,0.16)", background: "rgba(255,255,255,0.88)", borderRadius: 16, padding: "12px 10px", color: "#0F172A", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }, children: [_jsx("svg", { viewBox: "0 0 48 36", width: "40", height: "28", fill: "none", children: _jsx("path", { d: shapePath(kind, { x: 6, y: 5, w: 36, h: 24 }), fill: SHAPE_FILL, stroke: SHAPE_STROKE, strokeWidth: "1.5" }) }), _jsx("span", { style: { fontSize: 11, color: "#334155" }, children: label })] }, kind))) }) })) : null, popover === "line" ? (_jsx(Flyout, { title: "Connectors", onClose: closePopover, align: "left", children: _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [["straight", "elbow", "curve"].map((kind) => (_jsxs("button", { type: "button", onClick: () => updateScene({ lineKind: kind }), style: { border: lineKind === kind ? "1px solid rgba(91,115,255,0.4)" : "1px solid rgba(148,163,184,0.16)", background: lineKind === kind ? "rgba(91,115,255,0.09)" : "rgba(255,255,255,0.88)", borderRadius: 16, padding: "10px 12px", color: "#0F172A", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "space-between" }, children: [_jsx("span", { style: { textTransform: "capitalize", fontSize: 12 }, children: kind }), _jsx("svg", { viewBox: "0 0 44 26", width: "44", height: "26", fill: "none", children: kind === "straight" ? _jsx("path", { d: "M6 20L38 6", stroke: "#4154D6", strokeWidth: "2.4", strokeLinecap: "round" }) : kind === "elbow" ? _jsx("path", { d: "M6 20H24V6H38", stroke: "#4154D6", strokeWidth: "2.4", strokeLinecap: "round", strokeLinejoin: "round" }) : _jsx("path", { d: "M6 20C16 20 18 6 30 6C34 6 36 9 38 11", stroke: "#4154D6", strokeWidth: "2.4", strokeLinecap: "round" }) })] }, kind))), _jsx("div", { style: { fontSize: 11, color: "#64748B", lineHeight: 1.5 }, children: "Straight lines snap to `0\u00B0 / 45\u00B0 / 90\u00B0` and show live guide chips." })] }) })) : null, popover === "sticky" ? (_jsxs(Flyout, { title: "Sticky notes", onClose: closePopover, align: "left", children: [_jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center" }, children: STICKY_COLORS.map((color) => _jsx("button", { type: "button", onClick: () => updateScene({ stickyColor: color }), style: { width: 28, height: 28, borderRadius: 999, border: stickyColor === color ? "2px solid rgba(15,23,42,0.75)" : "2px solid rgba(255,255,255,0.85)", background: color, boxShadow: "0 6px 14px rgba(15,23,42,0.10)", cursor: "pointer" } }, color)) }), _jsx("div", { style: { marginTop: 10, fontSize: 11, color: "#64748B", lineHeight: 1.5 }, children: "Sticky notes are the only elements sent to AI in v1." })] })) : null] }), selectedElement && activeTool === "select" && !isEditing ? (_jsxs("div", { "data-no-board-draw": "true", style: {
                                ...
                                overflow: "hidden",
                            }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 14px 10px", borderBottom: "1px solid rgba(15,23,42,0.06)" }, children: [_jsx("div", { style: { fontSize: 11, fontWeight: 700, letterSpacing: "0.11em", textTransform: "uppercase", color: "#52607A" }, children: selectedElement.type === "stroke" ? "Stroke" : selectedElement.type === "shape" ? "Shape" : selectedElement.type === "line" ? "Line" : selectedElement.type === "sticky" ? "Sticky Note" : "Text" }), _jsx("button", { type: "button", onClick: () => updateSelection(null), style: { border: "none", background: "transparent", color: "#64748B", cursor: "pointer", display: "grid", placeItems: "center" }, children: _jsx(IconClose, {}) })] }), _jsxs("div", { style: { padding: 12, display: "flex", flexDirection: "column", gap: 10 }, children: [(selectedElement.type === "stroke" || selectedElement.type === "line") ? (_jsxs("div", { children: [_jsx("div", { style: { fontSize: 10, fontWeight: 600, color: "#94A3B8", marginBottom: 6, letterSpacing: "0.06em" }, children: "COLOR" }), _jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: COLORS.map((color) => (_jsx("button", { type: "button", onClick: () => {
                                                            patchElements((list) => list.map((entry) => {
                                                                if (entry.id !== selectedElement.id)
                                                                    return entry;
                                                            ...
                                                            border: (selectedElement.type === "stroke" || selectedElement.type === "line") && selectedElement.color === color ? "2px solid rgba(15,23,42,0.8)" : "2px solid rgba(255,255,255,0.8)",
                                                            background: color, boxShadow: "0 4px 10px rgba(15,23,42,0.10)", cursor: "pointer",
                                                        } }, color))) })] })) : null, selectedElement.type === "sticky" ? (_jsxs("div", { children: [_jsx("div", { style: { fontSize: 10, fontWeight: 600, color: "#94A3B8", marginBottom: 6, letterSpacing: "0.06em" }, children: "COLOR" }), _jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: STICKY_COLORS.map((color) => (_jsx("button", { type: "button", onClick: () => {
                                                            patchElements((list) => list.map((entry) => entry.id === selectedElement.id && entry.type === "sticky" ? { ...entry, color } : entry));
                                                        }, style: {
                                                            width: 22, height: 22, borderRadius: 999,
                                                            border: selectedElement.color === color ? "2px solid rgba(15,23,42,0.8)" : "2px solid rgba(255,255,255,0.8)",
                                                            background: color, boxShadow: "0 4px 10px rgba(15,23,42,0.10)", cursor: "pointer",
                                                        } }, color))) })] })) : null, (selectedElement.type === "shape" || selectedElement.type === "sticky" || selectedElement.type === "text") ? (_jsxs("div", { style: { display: "flex", gap: 8 }, children: [_jsxs("div", { style: { flex: 1, borderRadius: 12, border: "1px solid rgba(148,163,184,0.16)", background: "rgba(248,250,252,0.8)", padding: "8px 10px" }, children: [_jsx("div", { style: { fontSize: 9, fontWeight: 600, color: "#94A3B8", letterSpacing: "0.06em" }, children: "W" }), _jsxs("div", { style: { fontSize: 13, fontWeight: 600, color: "#1E293B", fontFamily: "ui-monospace, SFMono-Regular, monospace" }, children: [Math.round(selectedElement.w * size.width), "px"] })] }), _jsxs("div", { style: { flex: 1, borderRadius: 12, border: "1px solid rgba(148,163,184,0.16)", background: "rgba(248,250,252,0.8)", padding: "8px 10px" }, children: [_jsx("div", { style: { fontSize: 9, fontWeight: 600, color: "#94A3B8", letterSpacing: "0.06em" }, children: "H" }), _jsxs("div", { style: { fontSize: 13, fontWeight: 600, color: "#1E293B", fontFamily: "ui-monospace, SFMono-Regular, monospace" }, children: [Math.round(selectedElement.h * size.height), "px"] })] })] })) : null, selectedElement.type === "line" ? (_jsxs("div", { style: { borderRadius: 12, border: "1px solid rgba(148,163,184,0.16)", background: "rgba(248,250,252,0.8)", padding: "8px 10px" }, children: [_jsx("div", { style: { fontSize: 9, fontWeight: 600, color: "#94A3B8", letterSpacing: "0.06em" }, children: "LENGTH" }), _jsxs("div", { style: { fontSize: 13, fontWeight: 600, color: "#1E293B", fontFamily: "ui-monospace, SFMono-Regular, monospace" }, children: [Math.round(dist(denormalizePoint({ x: selectedElement.x1, y: selectedElement.y1 }, size.width, size.height), denormalizePoint({ x: selectedElement.x2, y: selectedElement.y2 }, size.width, size.height))), "px"] })] })) : null, selectedElement.type === "stroke" ? (_jsxs("div", { style: { display: "flex", gap: 8 }, children: [_jsxs("div", { style: { flex: 1, borderRadius: 12, border: "1px solid rgba(148,163,184,0.16)", background: "rgba(248,250,252,0.8)", padding: "8px 10px" }, children: [_jsx("div", { style: { fontSize: 9, fontWeight: 600, color: "#94A3B8", letterSpacing: "0.06em" }, children: "BRUSH" }), _jsx("div", { style: { fontSize: 12, fontWeight: 600, color: "#1E293B", textTransform: "capitalize" }, children: selectedElement.brush })] }), _jsxs("div", { style: { flex: 1, borderRadius: 12, border: "1px solid rgba(148,163,184,0.16)", background: "rgba(248,250,252,0.8)", padding: "8px 10px" }, children: [_jsx("div", { style: { fontSize: 9, fontWeight: 600, color: "#94A3B8", letterSpacing: "0.06em" }, children: "WIDTH" }), _jsxs("div", { style: { fontSize: 13, fontWeight: 600, color: "#1E293B", fontFamily: "ui-monospace, SFMono-Regular, monospace" }, children: [selectedElement.width, "px"] })] })] })) : null, _jsxs("div", { style: { display: "flex", gap: 6, paddingTop: 4 }, children: [_jsxs("button", { type: "button", title: "Duplicate", onClick: () => {
                                                        const clone = { ...selectedElement, id: createId(selectedElement.type) };
                                                        if ("x" in clone && "y" in clone && clone.type !== "line") {
                                                            clone.x = Math.min(clone.x + 0.02, 0.9);
                                                            clone.y = Math.min(clone.y + 0.02, 0.9);
                                                        }
                                                        emitChange({ ...latestSceneRef.current, elements: [...(latestSceneRef.current.elements ?? []), clone], selectedId: clone.id });
                                                    }, style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 5, padding: "9px 0", borderRadius: 14, border: "1px solid rgba(148,163,184,0.16)", background: "rgba(255,255,255,0.88)", color: "#334155", cursor: "pointer", fontSize: 11, fontWeight: 600 }, children: [_jsx(IconDuplicate, {}), " Duplicate"] }), _jsxs("button", { type: "button", title: "Delete", onClick: () => {
                                                        setSelectedIds([]);
                                            ...
                                            if (entry.type === "line") {
                                                ...
                                                return (_jsxs("g", { children: [_jsx("path", { d: d, fill: "none", stroke: "transparent", strokeWidth: Math.max(entry.width + 12, 14), strokeLinecap: "round", strokeLinejoin: "round", pointerEvents: "stroke", onPointerDown: (event) => handleElementPointerDown(entry, event), style: { cursor: activeTool === "select" ? "move" : "pointer" } }), _jsx("path", { d: d, fill: "none", stroke: entry.color, strokeWidth: entry.width, strokeLinecap: "round", strokeLinejoin: "round", filter: "url(#shadow-soft)", pointerEvents: "none", markerEnd: "url(#arrowhead)", style: { color: entry.color } })] }, entry.id));
                                            }
                                            return null;
                                        })] }), elements.map((entry) => {
